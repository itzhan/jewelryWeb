  ...
  return (
    <div className="bg-black text-white py-12 sm:py-16">
      <div className="page-width">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-10 sm:mb-12">
          <h2 className="text-2xl sm:text-4xl font-serif">OUR COUPLES</h2>
          <div className="flex gap-2">
            <button className="p-2 sm:p-3 border border-white rounded-full hover:bg-white hover:text-black transition-colors">
...
function CoupleStory({ names, story }: { names: string; story: string }) {
  ...
  <div>
    ...
    <h3 className="font-bold text-lg sm:text-xl mb-2">{names}</h3>
    <p className="text-gray-300 mb-4 text-sm sm:text-base">{story}</p>
